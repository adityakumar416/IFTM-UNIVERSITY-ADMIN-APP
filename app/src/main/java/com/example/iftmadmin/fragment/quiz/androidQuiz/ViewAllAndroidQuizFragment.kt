...
import com.example.iftmadmin.databinding.FragmentViewAllAndroidQuizBinding
import com.example.iftmadmin.fragment.quiz.basicComputerQuiz.BasicComputerQuizModel
import com.example.iftmadmin.fragment.quiz.basicComputerQuiz.ShowBasicComputerQuizAdapter
import com.google.firebase.database.DataSnapshot
import com.google.firebase.database.DatabaseError
import com.google.firebase.database.FirebaseDatabase
import com.google.firebase.database.ValueEventListener

class ViewAllAndroidQuizFragment : Fragment() {
    private lateinit var binding: FragmentViewAllAndroidQuizBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentViewAllAndroidQuizBinding.inflate(layoutInflater, container, false)

        binding.recyclerview.layoutManager = LinearLayoutManager(context)
        basicComputerQuestionList = arrayListOf()

        val databaseReference = FirebaseDatabase.getInstance().getReference("androidQuiz")
