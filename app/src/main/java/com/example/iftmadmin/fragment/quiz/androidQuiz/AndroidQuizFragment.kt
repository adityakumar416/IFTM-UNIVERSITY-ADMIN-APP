...
import com.example.iftmadmin.databinding.FragmentAndroidQuizBinding
...
class AndroidQuizFragment : Fragment() {
    private lateinit var binding: FragmentAndroidQuizBinding
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        // Inflate the layout for this fragment
        binding = FragmentAndroidQuizBinding.inflate(layoutInflater, container, false)
    ...
    private fun addDataToFirebase(question: String, optionA: String, optionB: String, optionC: String, optionD: String, answer: String) {
        ...
        val firebaseDatabase = FirebaseDatabase.getInstance().getReference("androidQuiz")
